            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        <li class="breadcrumb-item"><a href="{{ url('accounts/checker/dashboard') }}"><i
            ...
            <hr/> --}}
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a class="nav-link dropdown-toggle-nocaret position-relative btn btn-outline-primary p-1"
                        href="{{ route('accounts.acc-post-return-from-uploader-listing') }}" role="button">
                        @if ($notification > 0)
                        ...
                        <table class="table mb-0 table-hover">
                            ...
                            <tbody>
                                ...
                                @foreach ($chittis as $chitti)
                                    <tr>
                                        <th scope="row" data-id="{{ $chitti->chittiId }}">
                                            {{ $index }}
                                        </th>
