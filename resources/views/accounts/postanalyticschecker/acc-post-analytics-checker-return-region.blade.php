    ...
    <div class="row">
        <div class="card" style="padding-top: 15px;">
            <div class="col-xl-9 mx-auto w-100">
                ...
                <form  action="{{ route('accounts.acc-post-analytics-checker-sendtomaker', ['id' => $chitti->chittiId]) }}?checkerId={{ $chitti->makerId }}&City={{ $chitti->areaId }}&sendtomaker=sendtomaker" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
