...
@section('title', 'New Account Maker Register')
        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Maker Account Register</li>
                </ol>
            </nav>
        </div>
    </div>
                ...
                <form  action="{{ url('/accounts/maker/acc-maker-store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="image-preview-mt" id="image-preview" style="max-width: 300px; max-height: 300px; overflow: hidden; border: 1px solid #ccc; padding: 5px;">
                                <img id="preview-img" src="/img/blankImage2.png" alt="Image Preview" style="width: 288px; height: 250px; background-size: cover;" />
                            </div>
                        </div>
                        <div class="col-md-2">
                            <label>Thumbnails</label>
                            <div id="thumbnails" class="d-flex flex-wrap" style="gap: 10px; border: 1px solid #ccc; padding: 5px; min-height: 80px; background-color: #28252517;">
                                <div class="thumbnail-slot" id="slot-1" style="background-image: url('/img/blankImage2.png'); background-size: cover; width:100%; height:100px;position:relative;">
                                    <input type="checkbox" class="thumbnail-checkbox" id="checkbox-1" style="position: absolute; top: 2px; left: 2px; display: none;">
                                </div>
                                <div class="thumbnail-slot" id="slot-2" style="background-image: url('/img/blankImage2.png'); background-size: cover; width:100%; height:100px;position:relative;">
                                    <input type="checkbox" class="thumbnail-checkbox" id="checkbox-2" style="position: absolute; top: 2px; left: 2px; display: none;">
                                </div>
                                <div class="thumbnail-slot" id="slot-3" style="background-image: url('/img/blankImage2.png'); background-size: cover; width:100%; height:100px;position:relative;">
                                    <input type="checkbox" class="thumbnail-checkbox" id="checkbox-3" style="position: absolute; top: 2px; left: 2px; display: none;">
                                </div>
                                <div class="thumbnail-slot" id="slot-4" style="background-image: url('/img/blankImage2.png'); background-size: cover; width:100%; height:100px;position:relative;">
                                    <input type="checkbox" class="thumbnail-checkbox" id="checkbox-4" style="position: absolute; top: 2px; left: 2px; display: none;">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-md-12">
                            ...
                            <input type="file" class="form-control @error('makerImage') is-invalid @enderror" id="makerImage" name="makerImage" onchange="previewImage()">
                            @error('makerImage')
                                <p class="invalid-feedback">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="col-sm-2">
                            <div class="form-check">
                                <input class="form-check-input @error('isCultureNature') is-invalid @enderror"
                                    ...
                                    {{ old('isCultureNature') == '1' ? 'checked' : 'checked' }}> <!-- Default checked -->
