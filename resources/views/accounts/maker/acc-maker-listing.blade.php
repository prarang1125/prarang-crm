            ...
            <div class="col-xl-9 mx-auto w-100">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a class="nav-link dropdown-toggle-nocaret position-relative btn btn-outline-primary p-1"
                        href="{{ route('accounts.acc-post-return-from-checker-listing') }}" role="button">
                        @if ($notification > 0)
                                ...
                                @foreach ($chittis as $chitti)
                                    <tr>
                                        <th scope="row" class="" data-id="{{ $chitti->chittiId }}">
                                            {{ $index }}</th>
                                        <td class=""><a
                                                href="{{ route('accounts.acc-maker-edit', $chitti->chittiId) }}"
                                                class="text-primary">
                                                {{ $chitti->Title }}
                                            </a></td>
                                        ...
                                        <td class="">
                                            @if ($chitti->checkerStatus != 'maker_to_checker' && $chitti->checkerStatus != 'sent_to_uploader')
                                                ...
                                                <a href="{{ route('accounts.acc-maker-delete', $chitti->chittiId) }}"
