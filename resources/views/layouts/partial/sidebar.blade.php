...
<ul class="metismenu" id="menu">
    @if (Auth::guard('admin')->check())
        ...
        <li>
            ...
            <ul>
                <li> <a href="{{ route('admin.bilateral-portals.index') }}"><i class="bx bx-right-arrow-alt"></i>Manage Portals</a></li>
                <li> <a href="{{ route('admin.country-portals.index') }}"><i class="bx bx-right-arrow-alt"></i>Manage Countries</a></li>
            </ul>
        </li>
