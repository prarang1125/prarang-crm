                            ...
                            <form  action="{{ route('portal.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <input class="form-control"   type="number" name="city_id" id="city_id" value="{{ old('city_id') }}" required>
                                        @error('city_id')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-sm-4">
                                        ...
                                        <input class="form-control"  type="text" name="city_code" id="city_code" value="{{ old('city_code') }}" required>
                                        @error('city_code')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                             ...
                             <div class="row mt-3">
                                <div class="col-sm-6">
                                    ...
                                    <input class="form-control"  type="text" name="city_name_local" id="city_name_local" value="{{ old('city_name_local') }}">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input class="form-control"  type="text" name="city_slogan" id="city_slogan" value="{{ old('city_slogan') }}">
                                    @error('city_slogan')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="row mt-3">
                                    <div class="col-sm-6">
                                        ...
                                        <input class="form-control"  type="text" name="local_lang" id="local_lang" value="{{ old('local_lang') }}">
                                        @error('local_lang')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="mt-3">
                                    ...
                                    <input class="form-control"  type="url" name="map_link" id="map_link" value="{{ old('map_link') }}">
                                    @error('map_link')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input 
                                            ...
                                            id="header_image" 
                                            accept="image/*" 
                                            onchange="previewImage(this, 'header_preview')">
                                        @error('header_image')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                        <div class="mt-2">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input 
                                            ...
                                            id="footer_image" 
                                            accept="image/*" 
                                            onchange="previewImage(this, 'footer_preview')">
                                        @error('footer_image')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                        <div class="mt-2">
