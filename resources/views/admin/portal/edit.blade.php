                        ...
                        <form  action="{{ route('portal.update',['portal'=>$portal->id]) }}" method="POST" enctype="multipart/form-data">
                         ...
                         <div class="row mt-3">
                            ...
                            <div class="mt-3">
                                ...
                                <textarea class="form-control"  name="weather_widget_code" id="weather_widget_code" placeholder='<div id="openweathermap-widget-15"></div>
<script>
...
</script>'>{{ old('weather_widget_code',$portal->weather_widget_code) }}</textarea>
