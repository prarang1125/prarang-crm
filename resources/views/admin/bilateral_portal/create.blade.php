...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-xl-9 mx-auto">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.bilateral-portals.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-sm-9 text-secondary">
                                <select name="primary_country_id" class="form-select" required>
                                    ...
                                    @foreach($countries as $country)
                                        <option value="{{ $country->id }}" {{ old('primary_country_id') == $country->id ? 'selected' : '' }}>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9 text-secondary">
                                <select name="secondary_country_id" class="form-select" required>
                                    ...
                                    @foreach($countries as $country)
                                        <option value="{{ $country->id }}" {{ old('secondary_country_id') == $country->id ? 'selected' : '' }}>
                                            {{ $country->country_name }} ({{ $country->country_code }})
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9 text-secondary">
                                <input type="text" name="content_country_code" class="form-control" value="{{ old('content_country_code') }}" maxlength="10">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9 text-secondary">
                                ...
                                <small class="form-text text-muted">Upload header image (JPEG, PNG, JPG, GIF - Max: 2MB)</small>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9 text-secondary">
                                ...
                                <small class="form-text text-muted">Upload footer image (JPEG, PNG, JPG, GIF - Max: 2MB)</small>
                            </div>
                        </div>
                        
                        <div class="row mb-3">
                            <div class="col-sm-3">
                                <h6 class="mb-0">Connections (JSON)</h6>
                            </div>
                            <div class="col-sm-9 text-secondary">
                                <textarea name="connections" class="form-control" rows="4">{{ old('connections') }}</textarea>
                                <small class="form-text text-muted">JSON data for connections information</small>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9 text-secondary">
                                <textarea name="header_scripts" class="form-control" rows="3">{{ old('header_scripts') }}</textarea>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9 text-secondary">
                                <textarea name="footer_scripts" class="form-control" rows="3">{{ old('footer_scripts') }}</textarea>
