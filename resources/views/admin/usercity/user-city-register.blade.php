...
@section('title', 'User City Register')
        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">User City Register</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="row">
        <div class="card" style="padding-top: 15px;">
            <div class="col-xl-9 mx-auto w-100">
                ...
                @endif
                <h6 class="mb-0 text-uppercase text-primary">Create New User City</h6>
                <hr/>
                <form  action="{{ url('/admin/usercity/user-city-store') }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('cityNameInHindi') is-invalid @enderror" id="cityNameInHindi" name="cityNameInHindi" value="{{ old('cityNameInHindi') }}" >
                        ...
                        <div class="col-md-6">
                            ...
                            <select id="countryId" class="form-select @error('countryId') is-invalid @enderror" name="countryId">
                                ...
                                @foreach($userCountries as $userCountry)
                                    <option value="{{ $userCountry->countryId }}" {{ old('countryId') == $userCountry->countryId ? 'selected' : '' }}>{{ $userCountry->countryNameInEnglish }}</option>
                                @endforeach
                            </select>
                            @error('countryId')
                                <p class="invalid-feedback">{{ $message }}</p>
