        ...
        <div class="row">
            <div class="card" style="padding-top: 15px;">
                <div class="col-xl-9 mx-auto w-100">
                    ...
                    <hr />
                    <form
                        action="{{ route('admin.post-analytics-checker-sendtomaker', ['id' => $chitti->chittiId]) }}?checkerId={{ $chitti->makerId }}&City={{ $chitti->areaId }}&sendtomaker=sendtomaker&cityCode={{ Request::query('cityCode') }}"
                        ...
                        <div class="row mt-1">
                            <div class="col-md-6">
                                ...
                                <textarea class="form-control @error('returnToMakerWithRegion') is-invalid @enderror" id="returnToMakerWithRegion"
                                    name="returnToMakerWithRegion">{{ old('returnToMakerWithRegion') }}</textarea>
