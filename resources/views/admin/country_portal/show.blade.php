                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <a href="{{ route('admin.country-portals.edit', $countryPortal) }}"
                                    ...
                                    <div class="card-body">
                                        <table class="table table-borderless">
                                            ...
                                            <tr>
                                                ...
                                                <td><span class="badge bg-primary">{{ $countryPortal->country_code }}</span>
                                                </td>
                                            </tr>
                                            @if ($countryPortal->country_name_locale)
                                                <tr>
                                            ...
                                            @if ($countryPortal->locale_lang)
                                                <tr>
                                                    ...
                                                    <td><span
                                                            class="badge bg-info">{{ $countryPortal->locale_lang }}</span>
                                                    </td>
                                                </tr>
                                            @endif
                            ...
                            <div class="col-md-6">
                                <div class="card border-success">
                                    ...
                                    <div class="card-body">
                                        <table class="table table-borderless">
                                            ...
                                            @if ($countryPortal->maps)
                                                <tr>
                                                    ...
                                                    <td><a href="{{ $countryPortal->maps }}"
                                                            target="_blank">{{ Str::limit($countryPortal->maps, 50) }}</a>
                                                    </td>
                                                </tr>
                                            @endif
                                            @if ($countryPortal->embassy_link)
                                                <tr>
                                                    ...
                                                    <td><a href="{{ $countryPortal->embassy_link }}"
                                                            target="_blank">{{ Str::limit($countryPortal->embassy_link, 50) }}</a>
                                                    </td>
                                                </tr>
                                            @endif
                                        </table>
                                        ...
                                        @if (
                                            !$countryPortal->anlytics_code &&
                                                !$countryPortal->analytics_slug &&
                                                !$countryPortal->maps &&
                                                !$countryPortal->embassy_link)
                            ...
                            <div class="col-12">
                                <div class="card border-warning">
                                    ...
                                    <div class="card-body">
                                        ...
                                        @if ($totalPortals > 0)
                                            <div class="row">
                                                @if ($primaryPortals->count() > 0)
                                                    <div class="col-md-6">
                                                        <h6 class="text-primary">As Primary Country
                                                            ({{ $primaryPortals->count() }})</h6>
                                                        <ul class="list-group list-group-flush">
                                                            @foreach ($primaryPortals as $portal)
                                                                <li
                                                                    class="list-group-item d-flex justify-content-between align-items-center">
                                                                    {{ $portal->title }}
                                                                    <a href="{{ route('admin.bilateral-portals.show', $portal) }}"
                                                ...
                                                @if ($secondaryPortals->count() > 0)
                                                    <div class="col-md-6">
                                                        <h6 class="text-secondary">As Secondary Country
                                                            ({{ $secondaryPortals->count() }})</h6>
                                                        <ul class="list-group list-group-flush">
                                        ...
                                        @else
                                            <p class="text-muted text-center">This country is not used in any bilateral
                                                portals yet.</p>
                                            <div class="text-center">
                                                <a href="{{ route('admin.bilateral-portals.create') }}"
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                @if ($countryPortal->news)
                                                    <div class="col-md-6 mb-3">
                                                        <h6>News Sources & Categories</h6>
                                                        @php
                                                            $news = is_string($countryPortal->news)
                                                                ? json_decode($countryPortal->news, true)
                                                                : $countryPortal->news;
                                                        @endphp
                                                        @if (is_array($news))
                                                            @if (isset($news['sources']) && is_array($news['sources']) && count($news['sources']) > 0)
                                                                <div class="mb-3">
                                                            ...
                                                            @if (isset($news['categories']) && is_array($news['categories']) && count($news['categories']) > 0)
                                                                <div class="mb-3">
                                                                    <strong>News Categories:</strong>
                                                                    <div class="mt-2">
                                                                        @foreach ($news['categories'] as $category)
                                                                            <span
                                                                                class="badge bg-info me-1">{{ $category }}</span>
                                                                        @endforeach
                                                                    </div>
                                                                </div>
                                                            @endif
                                                            ...
                                                            @if (
                                                                (!isset($news['sources']) || count($news['sources']) == 0) &&
                                                                    (!isset($news['categories']) || count($news['categories']) == 0))
                                                                <p class="text-muted">No news data available.</p>
                                                            @endif
                                                        @else
                                                            <pre class="bg-light p-3 rounded"><code>{{ json_encode($news, JSON_PRETTY_PRINT) }}</code></pre>
                                                        @endif
                                                    </div>
                                                @endif
                                                ...
                                                @if ($countryPortal->local_metrics)
                                                    <div class="col-md-6 mb-3">
                                                        <h6>Local Metrics</h6>
                                                        @php
                                                            $metrics = is_string($countryPortal->local_metrics)
                                                                ? json_decode($countryPortal->local_metrics, true)
                                                        ...
                                                        @else
                                                            <pre class="bg-light p-3 rounded"><code>{{ json_encode($metrics, JSON_PRETTY_PRINT) }}</code></pre>
                                                        @endif
                                                    </div>
                                                @endif
                                                ...
                                                @if ($countryPortal->important_links)
                                                    <div class="col-md-12 mb-3">
                                                        ...
                                                        @if (is_array($links))
                                                            @if (isset($links['general']) && is_array($links['general']) && count($links['general']) > 0)
                                                                <div class="mb-3">
                                                                    <strong class="text-warning">General Important
                                                                        Links:</strong>
                                                                    <ul class="list-group mt-2">
                                                                        @foreach ($links['general'] as $link)
                                                                            <li
                                                                                class="list-group-item d-flex justify-content-between align-items-center">
                                                                                @if (is_array($link) && isset($link['name']) && isset($link['url']))
                                                                                    <div>
                                                                                        <strong>{{ $link['name'] }}</strong>
                                                                                        @if ($link['url'])
                                                                                            <br><small
                                                                                                class="text-muted">{{ $link['url'] }}</small>
                                                                                        @endif
                                                                                    </div>
                                                                                    @if ($link['url'])
                                                                                        <a href="{{ $link['url'] }}"
                                                                                    ...
                                                                                    @endif
                                                                                @else
                                                                                    <a href="{{ is_array($link) ? $link['url'] ?? $link : $link }}"
                                                                                        target="_blank"
                                                                                        class="text-decoration-none">
                                                                                        {{ is_array($link) ? $link['url'] ?? $link : $link }}
                                                                                        <i
                                                                                            class="bx bx-link-external ms-1"></i>
                                                                                    </a>
                                                                                @endif
                                                                            </li>
                                                                        @endforeach
                                                            ...
                                                            @if (isset($links['tourist_places']) && is_array($links['tourist_places']) && count($links['tourist_places']) > 0)
                                                                <div class="mb-3">
                                                                    ...
                                                                    <ul class="list-group mt-2">
                                                                        @foreach ($links['tourist_places'] as $link)
                                                                            <li
                                                                                class="list-group-item d-flex justify-content-between align-items-center">
                                                                                @if (is_array($link) && isset($link['name']) && isset($link['url']))
                                                                                    <div>
                                                            ...
                                                            @if (isset($links['community_pages']) && is_array($links['community_pages']) && count($links['community_pages']) > 0)
                                                                <div class="mb-3">
                                                                    ...
                                                                    <ul class="list-group mt-2">
                                                                        @foreach ($links['community_pages'] as $link)
                                                                            <li
                                                                                class="list-group-item d-flex justify-content-between align-items-center">
                                                                                @if (is_array($link) && isset($link['name']) && isset($link['url']))
                                                                                    <div>
                                                            ...
                                                            @if (isset($links['resources']) && is_array($links['resources']) && count($links['resources']) > 0)
                                                                <div class="mb-3">
                                                                    ...
                                                                    <ul class="list-group mt-2">
                                                                        @foreach ($links['resources'] as $link)
                                                                            <li
                                                                                class="list-group-item d-flex justify-content-between align-items-center">
                                                                                @if (is_array($link) && isset($link['name']) && isset($link['url']))
                                                                                    <div>
                                                            ...
                                                            @if (
                                                                (!isset($links['general']) || count($links['general']) == 0) &&
                                                                    (!isset($links['tourist_places']) || count($links['tourist_places']) == 0) &&
                    ...
                    <div class="card-footer">
                        <div class="d-flex justify-content-between">
                            <div>
                                @if ($totalPortals == 0)
                                    <form action="{{ route('admin.country-portals.destroy', $countryPortal) }}"
                                        method="POST" class="d-inline"
                                        onsubmit="return confirm('Are you sure you want to delete this country portal? This action cannot be undone.')">
                                        @csrf
                                        @method('DELETE')
                                ...
                                @else
                                    <button type="button" class="btn btn-danger" disabled
                                        title="Cannot delete country that is used in bilateral portals">
                                        <i class="bx bx-trash"></i> Delete Country (Used in {{ $totalPortals }}
                                        portal{{ $totalPortals > 1 ? 's' : '' }})
                                    </button>
                                @endif
                            </div>
                            <div>
