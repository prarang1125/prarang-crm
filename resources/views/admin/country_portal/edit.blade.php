                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="timezone" id="timezone_select"
                                                ...
                                                $offset_prefix = $offset < 0 ? '-' : '+' ;
                                                    $offset_formatted=gmdate('H:i', abs($offset)); $timezone_offsets[
                                                    $timezone ]="(UTC{$offset_prefix}{$offset_formatted}) {$timezone}" ;
                                                    } asort($timezone_offsets); $selectedTimezone=old('timezone',
                                                    $countryPortal->timezone);
                                                    @endphp
                                                    @foreach ($timezone_offsets as $tz_value => $tz_label)
                                                    <option value="{{ $tz_value }}" {{ $selectedTimezone==$tz_value
                                                        ? 'selected' : '' }}>
                                                        {{ $tz_label }}
                                                    </option>
                                                    @endforeach
                            ...
                            <div class="col-12">
                                <div class="card border-info">
                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea name="weather" class="form-control"
                                                        rows="6">{{ old('weather', $countryPortal->weather) }}</textarea>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div id="local-metrics-container">
                                                        ...
                                                        <div class="row mb-2 metric-row">
                                                            <div class="col-md-4">
                                                                <input type="text" class="form-control metric-key"
                                                                    placeholder="Metric Name (e.g., Population)"
                                                                    value="{{ $value['key'] ?? '' }}">
                                                            </div>
                                                            <div class="col-md-6">
                                                                <input type="text" class="form-control metric-value"
                                        ...
                                        <div class="mb-3">
                                            <livewire:excel-data-paster label="Important Links"
                                                inputName="important_links"
                                                :initialData="old('important_links', $countryPortal->important_links)" />
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="connections" class="form-control"
                                                    rows="4">{{ old('connections', $countryPortal->connections) }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="header_scripts" class="form-control"
                                                    rows="4">{{ old('header_scripts', $countryPortal->header_scripts) }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="footer_scripts" class="form-control"
                                                    rows="4">{{ old('footer_scripts', $countryPortal->footer_scripts) }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
