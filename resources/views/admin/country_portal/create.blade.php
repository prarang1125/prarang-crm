                                            ...
                                            <select name="timezone" id="timezone_select"
                                                ...
                                                @foreach ($timezone_offsets as $tz_value => $tz_label)
                                                    <option value="{{ $tz_value }}"
                                                        {{ old('timezone') == $tz_value ? 'selected' : '' }}>
                                                        {{ $tz_label }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea name="weather" class="form-control @error('weather') is-invalid @enderror" rows="6">{{ old('weather') }}</textarea>
                                                    @error('weather')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                ...
                                                <div class="card mb-3">
                                                    ...
                                                    <div class="card-body">
                                                        <div id="general-links-container">
                                                            <!-- Dynamic general links will be added here -->
                                                        </div>
                                                        <button type="button" class="btn btn-success btn-sm"
                                                            id="add-general-link">
                                                            <i class="bx bx-plus"></i> Add Important Link
                                                        </button>
                                                    </div>
                                                </div>
